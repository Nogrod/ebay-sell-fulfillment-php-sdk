...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.ebay.com/sell/fulfillment/v1';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/0.0.1/PHP';
    ...
    {
        $report  = 'PHP SDK (eBay\Sell\Fulfillment) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.20.6' . PHP_EOL;
