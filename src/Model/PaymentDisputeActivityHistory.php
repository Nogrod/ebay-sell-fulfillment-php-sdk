...
class PaymentDisputeActivityHistory implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentDisputeActivityHistory';
    ...
    protected static array $openAPITypes = [
        'activity' => '\eBay\Sell\Fulfillment\Model\PaymentDisputeActivity[]'
    ];
    ...
    */
     ...
     * Gets activity
     *
     * @return \eBay\Sell\Fulfillment\Model\PaymentDisputeActivity[]|null
     */
     ...
     * Sets activity
     *
     * @param \eBay\Sell\Fulfillment\Model\PaymentDisputeActivity[]|null $activity This array holds all activities of a payment dispute, from creation to resolution. For each activity, the activity type, the actor, and a timestamp is shown. The <strong>getActivities</strong> response is dynamic, and grows with each recorded activity.
     *
     * @return $this
     */
