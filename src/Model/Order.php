...
class Order implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $legacy_order_id <span class=\"tablenote\"><strong>Note:</strong> This field is deprecated and will stopped being returned on February 24, 2025. Please exclusively use the <b>orderId</b> field going forward.</span><br>The unique identifier of the order in legacy format, as traditionally used by the Trading API (and other legacy APIs). Both the <b>orderId</b> field and this field are always returned.
     *
     * @return $this
     */
    public function setLegacyOrderId(?string $legacy_order_id): static
    {
