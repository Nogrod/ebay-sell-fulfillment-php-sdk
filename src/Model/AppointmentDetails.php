...
class AppointmentDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AppointmentDetails';
    ...
    */
     ...
     * @return $this
     */
    public function setAppointmentEndTime(?string $appointment_end_time): static
    {
     ...
     * @return $this
     */
    public function setAppointmentStartTime(?string $appointment_start_time): static
    {
     ...
     * @return $this
     */
    public function setAppointmentType(?string $appointment_type): static
    {
     ...
     * @return $this
     */
    public function setAppointmentWindow(?string $appointment_window): static
    {
     ...
     * @return $this
     */
    public function setServiceProviderAppointmentDate(?string $service_provider_appointment_date): static
    {
