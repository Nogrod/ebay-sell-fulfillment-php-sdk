...
class LineItemReference implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'LineItemReference';
    ...
    */
     ...
     * Sets quantity
     *
     * @param int|null $quantity This is the number of lineItems associated with the <a href=\"#request.trackingNumber\">trackingNumber</a> specified by the seller. This must be a whole number greater than zero (0).<br><br><b>Default:</b> 1
     *
     * @return $this
     */
