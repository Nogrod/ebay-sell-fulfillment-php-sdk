...
class PaymentSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentSummary';
    ...
    */
     ...
     */
    public function getTotalDueSeller(): ?\eBay\Sell\Fulfillment\Model\Amount
    {
     ...
     * @return $this
     */
    public function setTotalDueSeller(?\eBay\Sell\Fulfillment\Model\Amount $total_due_seller): static
    {
