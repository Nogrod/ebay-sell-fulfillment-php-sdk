...
class CancelStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CancelStatus';
    ...
    */
     ...
     * @return $this
     */
    public function setCancelledDate(?string $cancelled_date): static
    {
     ...
     * @return $this
     */
    public function setCancelRequests(?array $cancel_requests): static
    {
     ...
     * @return $this
     */
    public function setCancelState(?string $cancel_state): static
    {
