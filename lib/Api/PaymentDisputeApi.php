...
/**
     ...
     * @param  \eBay\Sell\Fulfillment\Model\AcceptPaymentDisputeRequest $accept_payment_dispute_request accept_payment_dispute_request (optional)
     ...
     * @return void
     */
    public function acceptPaymentDispute($payment_dispute_id, $accept_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['acceptPaymentDispute'][0])
    {
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to accept. This identifier is automatically created by eBay once the payment dispute comes into the eBay system. The unique identifier for payment disputes is returned in the &lt;strong&gt;paymentDisputeId&lt;/strong&gt; field in the &lt;strong&gt;getPaymentDisputeSummaries&lt;/strong&gt; response.&lt;br&gt;&lt;br&gt;This path parameter is required, and the actual identifier value is passed in right after the &lt;strong&gt;payment_dispute&lt;/strong&gt; resource. See the Resource URI above. (required)
     * @param  \eBay\Sell\Fulfillment\Model\AcceptPaymentDisputeRequest $accept_payment_dispute_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['acceptPaymentDispute'] to see the possible values for this operation
     *
     ...
     */
    public function acceptPaymentDisputeWithHttpInfo($payment_dispute_id, $accept_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['acceptPaymentDispute'][0])
    {
     ...
     */
    public function acceptPaymentDisputeAsync($payment_dispute_id, $accept_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['acceptPaymentDispute'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function acceptPaymentDisputeAsyncWithHttpInfo($payment_dispute_id, $accept_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['acceptPaymentDispute'][0])
    {
        $returnType = '';
        $request = $this->acceptPaymentDisputeRequest($payment_dispute_id, $accept_payment_dispute_request, $hostIndex, $variables, $contentType);
    ...
    *    - basePath:  No description provided
     ...
     */
    public function acceptPaymentDisputeRequest($payment_dispute_id, $accept_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['acceptPaymentDispute'][0])
    {
     ...
     * @param  \eBay\Sell\Fulfillment\Model\AddEvidencePaymentDisputeRequest $add_evidence_payment_dispute_request add_evidence_payment_dispute_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     */
    public function addEvidence($payment_dispute_id, $add_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['addEvidence'][0])
    {
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to add evidence for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay system. The unique identifier for payment disputes is returned in the &lt;strong&gt;paymentDisputeId&lt;/strong&gt; field in the &lt;strong&gt;getPaymentDisputeSummaries&lt;/strong&gt; response.&lt;br&gt;&lt;br&gt;This path parameter is required, and the actual identifier value is passed in right after the &lt;strong&gt;payment_dispute&lt;/strong&gt; resource. See the Resource URI above. (required)
     * @param  \eBay\Sell\Fulfillment\Model\AddEvidencePaymentDisputeRequest $add_evidence_payment_dispute_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addEvidence'] to see the possible values for this operation
     *
     ...
     */
    public function addEvidenceWithHttpInfo($payment_dispute_id, $add_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['addEvidence'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\AddEvidencePaymentDisputeResponse' === '\SplFileObject') {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addEvidenceAsync($payment_dispute_id, $add_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['addEvidence'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addEvidenceAsyncWithHttpInfo($payment_dispute_id, $add_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['addEvidence'][0])
    {
        $returnType = '\eBay\Sell\Fulfillment\Model\AddEvidencePaymentDisputeResponse';
        $request = $this->addEvidenceRequest($payment_dispute_id, $add_evidence_payment_dispute_request, $hostIndex, $variables, $contentType);
    ...
    *    - basePath:  No description provided
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function addEvidenceRequest($payment_dispute_id, $add_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['addEvidence'][0])
    {
     ...
     * @param  \eBay\Sell\Fulfillment\Model\ContestPaymentDisputeRequest $contest_payment_dispute_request contest_payment_dispute_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @return void
     */
    public function contestPaymentDispute($payment_dispute_id, $contest_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contestPaymentDispute'][0])
    {
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to contest. This identifier is automatically created by eBay once the payment dispute comes into the eBay system. The unique identifier for payment disputes is returned in the &lt;strong&gt;paymentDisputeId&lt;/strong&gt; field in the &lt;strong&gt;getPaymentDisputeSummaries&lt;/strong&gt; response.&lt;br&gt;&lt;br&gt;This path parameter is required, and the actual identifier value is passed in right after the &lt;strong&gt;payment_dispute&lt;/strong&gt; resource. See the Resource URI above. (required)
     * @param  \eBay\Sell\Fulfillment\Model\ContestPaymentDisputeRequest $contest_payment_dispute_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contestPaymentDispute'] to see the possible values for this operation
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function contestPaymentDisputeWithHttpInfo($payment_dispute_id, $contest_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contestPaymentDispute'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contestPaymentDisputeAsync($payment_dispute_id, $contest_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contestPaymentDispute'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contestPaymentDisputeAsyncWithHttpInfo($payment_dispute_id, $contest_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contestPaymentDispute'][0])
    {
        $returnType = '';
        $request = $this->contestPaymentDisputeRequest($payment_dispute_id, $contest_payment_dispute_request, $hostIndex, $variables, $contentType);
    ...
    *    - basePath:  No description provided
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contestPaymentDisputeRequest($payment_dispute_id, $contest_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['contestPaymentDispute'][0])
    {
    ...
    *    - basePath:  No description provided
    ...
    public function getActivitiesWithHttpInfo($payment_dispute_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getActivities'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\PaymentDisputeActivityHistory' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    *    - basePath:  No description provided
    ...
    public function getPaymentDisputeWithHttpInfo($payment_dispute_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getPaymentDispute'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\PaymentDispute' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    *    - basePath:  No description provided
    ...
    public function getPaymentDisputeSummariesWithHttpInfo($order_id = null, $buyer_username = null, $open_date_from = null, $open_date_to = null, $payment_dispute_status = null, $limit = null, $offset = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getPaymentDisputeSummaries'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\DisputeSummaryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    *    - basePath:  No description provided
     ...
     * @param  \eBay\Sell\Fulfillment\Model\UpdateEvidencePaymentDisputeRequest $update_evidence_payment_dispute_request update_evidence_payment_dispute_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @return void
     */
    public function updateEvidence($payment_dispute_id, $update_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateEvidence'][0])
    {
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to update the evidence set for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay system. The unique identifier for payment disputes is returned in the &lt;strong&gt;paymentDisputeId&lt;/strong&gt; field in the &lt;strong&gt;getPaymentDisputeSummaries&lt;/strong&gt; response.&lt;br&gt;&lt;br&gt;This path parameter is required, and the actual identifier value is passed in right after the &lt;strong&gt;payment_dispute&lt;/strong&gt; resource. See the Resource URI above. (required)
     * @param  \eBay\Sell\Fulfillment\Model\UpdateEvidencePaymentDisputeRequest $update_evidence_payment_dispute_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateEvidence'] to see the possible values for this operation
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateEvidenceWithHttpInfo($payment_dispute_id, $update_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateEvidence'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEvidenceAsync($payment_dispute_id, $update_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateEvidence'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEvidenceAsyncWithHttpInfo($payment_dispute_id, $update_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateEvidence'][0])
    {
        $returnType = '';
        $request = $this->updateEvidenceRequest($payment_dispute_id, $update_evidence_payment_dispute_request, $hostIndex, $variables, $contentType);
    ...
    *    - basePath:  No description provided
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateEvidenceRequest($payment_dispute_id, $update_evidence_payment_dispute_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateEvidence'][0])
    {
     ...
     */
    public function uploadEvidenceFile($payment_dispute_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['uploadEvidenceFile'][0])
    {
        list($response) = $this->uploadEvidenceFileWithHttpInfo($payment_dispute_id, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     */
    public function uploadEvidenceFileWithHttpInfo($payment_dispute_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['uploadEvidenceFile'][0])
    {
        $request = $this->uploadEvidenceFileRequest($payment_dispute_id, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\FileEvidence' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadEvidenceFileAsync($payment_dispute_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['uploadEvidenceFile'][0])
    {
        return $this->uploadEvidenceFileAsyncWithHttpInfo($payment_dispute_id, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadEvidenceFileAsyncWithHttpInfo($payment_dispute_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['uploadEvidenceFile'][0])
    {
        $returnType = '\eBay\Sell\Fulfillment\Model\FileEvidence';
        $request = $this->uploadEvidenceFileRequest($payment_dispute_id, $hostIndex, $variables, $contentType);
    ...
    *    - basePath:  No description provided
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadEvidenceFileRequest($payment_dispute_id, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['uploadEvidenceFile'][0])
    {
