...
/**
     ...
     * @return object
     */
    public function createShippingFulfillment($order_id, $shipping_fulfillment_details, string $contentType = self::contentTypes['createShippingFulfillment'][0])
    {
     ...
     */
    public function createShippingFulfillmentWithHttpInfo($order_id, $shipping_fulfillment_details, string $contentType = self::contentTypes['createShippingFulfillment'][0])
    {
     ...
     */
    public function createShippingFulfillmentAsync($order_id, $shipping_fulfillment_details, string $contentType = self::contentTypes['createShippingFulfillment'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createShippingFulfillmentAsyncWithHttpInfo($order_id, $shipping_fulfillment_details, string $contentType = self::contentTypes['createShippingFulfillment'][0])
    {
        $returnType = 'object';
        $request = $this->createShippingFulfillmentRequest($order_id, $shipping_fulfillment_details, $contentType);
     ...
     */
    public function createShippingFulfillmentRequest($order_id, $shipping_fulfillment_details, string $contentType = self::contentTypes['createShippingFulfillment'][0])
    {
