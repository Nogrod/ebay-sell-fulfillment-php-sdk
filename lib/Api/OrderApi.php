...
/**
    ...
    public function getOrderWithHttpInfo($order_id, $field_groups = null, string $contentType = self::contentTypes['getOrder'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\Order' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eBay\Sell\Fulfillment\Model\Order' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Fulfillment\Model\Order', []),
    ...
    public function getOrdersWithHttpInfo($field_groups = null, $filter = null, $limit = null, $offset = null, $order_ids = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\OrderSearchPagedCollection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eBay\Sell\Fulfillment\Model\OrderSearchPagedCollection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Fulfillment\Model\OrderSearchPagedCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @param  \eBay\Sell\Fulfillment\Model\IssueRefundRequest $issue_refund_request issue_refund_request (optional)
     ...
     */
    public function issueRefund($order_id, $issue_refund_request = null, string $contentType = self::contentTypes['issueRefund'][0])
    {
     ...
     *
     * @param  string $order_id The unique identifier of the order. Order IDs are returned in the &lt;b&gt;getOrders&lt;/b&gt; method (and &lt;b&gt;GetOrders&lt;/b&gt; call of Trading API). The &lt;b&gt;issueRefund&lt;/b&gt; method supports the legacy API Order IDs and REST API order IDs. (required)
     * @param  \eBay\Sell\Fulfillment\Model\IssueRefundRequest $issue_refund_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['issueRefund'] to see the possible values for this operation
     *
     * @throws \eBay\Sell\Fulfillment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function issueRefundWithHttpInfo($order_id, $issue_refund_request = null, string $contentType = self::contentTypes['issueRefund'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Fulfillment\Model\Refund' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eBay\Sell\Fulfillment\Model\Refund' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Fulfillment\Model\Refund', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function issueRefundAsync($order_id, $issue_refund_request = null, string $contentType = self::contentTypes['issueRefund'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function issueRefundAsyncWithHttpInfo($order_id, $issue_refund_request = null, string $contentType = self::contentTypes['issueRefund'][0])
    {
        $returnType = '\eBay\Sell\Fulfillment\Model\Refund';
        $request = $this->issueRefundRequest($order_id, $issue_refund_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function issueRefundRequest($order_id, $issue_refund_request = null, string $contentType = self::contentTypes['issueRefund'][0])
    {
