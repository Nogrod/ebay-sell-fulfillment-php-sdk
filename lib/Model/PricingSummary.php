...
class PricingSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('price_discount_subtotal', $data ?? [], null);
    ...
    */
    ...
    public function setPriceDiscountSubtotal($price_discount_subtotal)
    {
        ...
        if (is_null($price_discount_subtotal)) {
            throw new \InvalidArgumentException('non-nullable price_discount_subtotal cannot be null');
        }
